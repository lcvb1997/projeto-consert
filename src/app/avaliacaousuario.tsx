...
const orders = [
  ...
  },
  {
    status: "Laura Sophie",
    rating: "★★★★★",
    description: "Foi super atencioso mas mora muito longe da minha casa kkkk, um dos melhores da região.",
    color: "#2E7D32",
  },{
    status: "Andressa Viana",
    rating: "★★★★★",
    description: "Esse moço é um profissional viu, resolveu o problema do som do meu celular rapidinho e o serviço é barato, recomendo",
    color: "#2E7D32",
  },
  {
    status: "Jonathan Santos",
    rating: "★★★★★",
    description: "Ajeitou meu telefone de maneira genial, o cara é mestre, ele manja...",
    color: "#2E7D32",
  },
